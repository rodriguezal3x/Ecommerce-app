    ...
    <Container>
        ...
        <Center>
            ...
            <List>
                ...
                <ListItem>Hombre Fashion</ListItem>
                <ListItem>Mujer Fashion</ListItem>
        ...
        <Right>
            <Title>Contact</Title>
            <ContactItem>
                <Room style={{marginRight:"10px"}}/> Costa Rica, Alajuela - Orotina Km 1, Colegio Santa Fe 100 mts Oeste.
            </ContactItem>
            <ContactItem>
                <Phone style={{marginRight:"10px"}}/> +506 62135758
            </ContactItem>
            <ContactItem>
                <MailOutline style={{marginRight:"10px"}}/> camilasstrore@gmail.com
            </ContactItem>
